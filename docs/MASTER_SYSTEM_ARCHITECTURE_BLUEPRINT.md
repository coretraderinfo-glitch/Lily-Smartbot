...
*   **Module Isolation:**
    *   **[ 📊 CALC ]**: Ledger management. Displays a **comprehensive visual list of all operational commands** (Start, Stop, Deposit, Payout, Bill, etc.), serving as a built-in manual for clients. All sub-buttons (Start/Stop) were removed to keep the interface focused on educational manual entry.
